              ...
              <div className="plan-content">
                ...
                <div className="plan-item">
                  ...
                  <ul className="endpoint-list">
                    {currentGoal.plan.endpoints.map((endpointId, idx) => (
                      <li key={idx}>
                ...
                <div className="plan-item">
                  ...
                  <div className="data-flow">
                    {currentGoal.plan.dataFlow.map((flow, idx) => (
                ...
                <div className="plan-item">
                  ...
                  <ul className="component-list">
                    {currentGoal.plan.uiStructure.components.map((comp, idx) => (
                      <li key={idx}>
                ...
                <div className="plan-item">
                  ...
                  <ul className="function-list">
                    {currentGoal.plan.functions.map((fn, idx) => (
                      <li key={idx}>
                        <code>{fn.name}()</code>
